  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-bold tracking-wider text-transparent md:text-7xl uppercase flex flex-col"
      >
        Mystry{" "}
        <span className="mt-5 text-base font-semibold capitalize">
          Sign In To Explore.
        </span>
      </motion.h1>
    </LampContainer>
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-lime-600 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
